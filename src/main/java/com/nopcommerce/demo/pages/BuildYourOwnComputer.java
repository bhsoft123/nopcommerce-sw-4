...
public class BuildYourOwnComputer extends Utility {
    ...
    public String getTextFromBuildYourComputer(){return getTextFromElement(buildYourComputerText); }
    ...
    public String getTextFromPrice(){         return getTextFromElement(priceText);    }
    ...
    public void verifyTheProductHasBeenAddedToYourShoppingCart(){
        getTextFromElement(verifyProductAddedToCart);
    }
    public void closeTheBarByClickingOnTheCrossButton(){        clickOnElement(closeTheBarMsg);    }
    public void mouseHoverOnShoppingCartButton(){         mouseHoverToElement(mouseHoverOnShoppingCart1);    }
